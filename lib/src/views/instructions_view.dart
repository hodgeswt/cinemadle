...
class InstructionsView extends StatelessWidget {
  ...
  final List<InstructionsCard> instructions = [
    ...
    const InstructionsCard(
        title: "Cast (11 of 11)",
        text:
            "The cast box shows the name of the first three highest-billed actors in the movie.\n\nThe cast box will appear yellow if the any one of these actors is also in the target movie cast.\n\nAny actor that matches one of the target movie's actor will be bolded and have a star.\n\nThe cast box will never have arrows."),
  ];
